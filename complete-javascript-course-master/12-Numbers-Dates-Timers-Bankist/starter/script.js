...
//      Internationlizing dates
//      Internationlizing numbers
/*
const num = 38883123.24;

const options = {
  style: `currency`,
  unit: `celsius`,
  currency: `EUR`,
  useGrouping: true, // Check mdn
};
...
console.log(`YoLoSwag waiting for pizza`);
...
setInterval(function () {
  ...
  const now = new Intl.DateTimeFormat(`lv-LV`, option).format();
  console.log(now);
}, 1000);
*/
